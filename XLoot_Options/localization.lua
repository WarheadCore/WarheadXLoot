...
local locales = {
	enUS = {
		Core = {
			panel_title = "Глобальные настройки",
		...
		Frame = {
			...
			-- Option labels
			autoloot_currency = "Автолут валюты",
			autoloot_currency_desc = "Автоматически поднимать из лута всю валюту",
			autoloot_quest = "Автолут квестовых предметов",
			autoloot_quest_desc = "Автоматически поднимать из лута все квестовые предметы",
			autoloot_tradegoods = "Автолут предметов для профессий",
			autoloot_tradegoods_desc = "Автоматически поднимать предметы, которые необходимы для профессий",
			autoloot_all = "Автолут всех предметов",
			...
			autoloot_list = "Автолут предметов из списка",
			autoloot_list_desc = "Автоматически поднимать из лута все предметы, которые перечислены в списке",
			autoloot_item_list = "Список предметов для автолута",

			autoloot_blacklist = "Чёрный список автолута предметов",
			autoloot_blacklist_desc = "Исключение из системы автолута предметов, которые поднимаются автоматически",
			autoloot_blackitem_list = "Список предметов для исключения из автолута",
