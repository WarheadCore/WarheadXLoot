		...
		local when_group = {
 		...
 		addon:RegisterOptions({ name = "Frame", addon =  XLootFrame.addon }, {
			...
			{ "autolooting", "group", {
				...
				{ "autoloot_boe", "select", when_group, "autoloots", "boe" },
				{ "autoloot_boe_quality", "select", item_qualities, "autoloots_quality", "boe_quality" },
				{ "autoloot_ap", "select", when_group, "autoloots", "ap" },
				{ "autoloot_bop", "select", when_group, "autoloots", "bop" },
				{ "autoloot_bop_quality", "select", item_qualities, "autoloots_quality", "bop_quality" },
				...
				{ "autoloot_blacklist", "select", when_group, "autoloots", "blacklist" },
				{ "autoloot_blackitem_list", "input", width = "double" },
	...
	if XLoot:GetModule("Monitor", true) then
		addon:RegisterOptions({ name = "Monitor", addon =  XLootMonitor.addon }, {
			...
			{ "thresholds", "group", {
				...
				{ "threshold_whitelist", "input", width = "double", name = "Список не игнорироемых вещей" },
				{ "threshold_blacklist", "input", width = "double", name = "Список игнорироемых вещей" },
			}},
			{ "filters", "group", {
				{ "show_coin", name = MONEY },
				{ "show_currency", name = CURRENCY },
				{ "show_ap", name = ARTIFACT_POWER },
				"show_crafted"
			}, name = FILTERS },
			{ "fading", "group", {
